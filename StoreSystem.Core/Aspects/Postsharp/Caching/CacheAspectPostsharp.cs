...
namespace StoreSystem.Core.Aspects.Postsharp.Caching
{
    [Serializable]
    public class CacheAspectPostsharp : MethodInterceptionAspect
    {
        ...
        public CacheAspectPostsharp(Type cacheType, int cacheByMinute = 60)
        {
